...
if Var.TG_BOT_USER_NAME_BF_HER is not None and tgbot is not None:
    ...
    async def on_plug_in_callback_query_handler(event):
        if event.query.user_id == bot.uid:  # pylint:disable=E0602
            ...
            reply_pop_up_alert = "Por favor, adquira seu próprio catuserbot e não use o meu!"
        ...
        if os.path.exists("./userbot/secrets.txt"):
            ...
            try:
                ...
                if event.query.user_id in ids:
                    ...
                    reply_pop_up_alert = "por que você estava olhando essa merda vai embora e faça seu próprio trabalho idiota"
            except KeyError:
                reply_pop_up_alert = "Esta mensagem não existe mais no servidor bot"
        else:
            reply_pop_up_alert = "Esta mensagem não existe mais "
        await event.answer(reply_pop_up_alert, cache_time=0, alert=True)
